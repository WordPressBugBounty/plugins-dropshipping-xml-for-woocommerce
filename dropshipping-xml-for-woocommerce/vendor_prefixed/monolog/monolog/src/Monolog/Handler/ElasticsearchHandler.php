...
use DropshippingXmlFreeVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use DropshippingXmlFreeVendor\Monolog\Logger;
use DropshippingXmlFreeVendor\Monolog\Formatter\FormatterInterface;
use DropshippingXmlFreeVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use DropshippingXmlFreeVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use DropshippingXmlFreeVendor\Elasticsearch\Client;
use DropshippingXmlFreeVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use DropshippingXmlFreeVendor\Elastic\Elasticsearch\Client as Client8;
/**
