...
class FormTemplate
{
    ...
    public function __construct(string $plugin_name)
    {
        $this->set_form_title(sprintf(
            ...
            __('You are deactivating %1$s plugin', 'dropshipping-xml-for-woocommerce'),
            $plugin_name
        ));
        $this->set_form_desc(__('If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'dropshipping-xml-for-woocommerce'));
    }
