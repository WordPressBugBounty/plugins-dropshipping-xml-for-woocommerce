...
?>";
			let nonce = "<?php 
echo \esc_attr(\wp_create_nonce(AjaxHandler::AJAX_ACTION));
?>";
			let alert_text = "<?php 
echo \esc_attr(\__('The action failed with an error: ', 'dropshipping-xml-for-woocommerce'));
?>";
			let enter_license_key = "<?php 
echo \esc_attr(\__('Enter license key', 'dropshipping-xml-for-woocommerce'));
?>";
