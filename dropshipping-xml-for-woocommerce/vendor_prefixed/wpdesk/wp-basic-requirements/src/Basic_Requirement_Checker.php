...
if (!\interface_exists('DropshippingXmlFreeVendor\WPDesk_Requirement_Checker')) {
    require_once __DIR__ . '/Requirement_Checker.php';
}
if (!\class_exists('DropshippingXmlFreeVendor\WPDesk_Basic_Requirement_Checker')) {
    /**
    ...
    class WPDesk_Basic_Requirement_Checker implements WPDesk_Requirement_Checker
    {
        ...
        private static function retrieve_plugins_data_in_transient($use_transients = \true)
        {
            ...
            if ($plugins === \false) {
                ...
                if (!\function_exists('get_plugins') && !\function_exists('DropshippingXmlFreeVendor\get_plugins')) {
