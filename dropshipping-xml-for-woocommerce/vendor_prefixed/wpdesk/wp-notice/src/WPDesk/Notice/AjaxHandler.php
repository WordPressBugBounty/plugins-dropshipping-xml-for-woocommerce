...
namespace DropshippingXmlFreeVendor\WPDesk\Notice;

use DropshippingXmlFreeVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use DropshippingXmlFreeVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
