...
namespace DropshippingXmlFreeVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'dropshipping-xml-for-woocommerce';
     ...
     */
    private function init_translations(\DropshippingXmlFreeVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \DropshippingXmlFreeVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \DropshippingXmlFreeVendor\WPDesk_Plugin_Info();
