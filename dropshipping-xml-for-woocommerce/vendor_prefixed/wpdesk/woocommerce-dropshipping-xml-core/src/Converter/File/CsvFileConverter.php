 ...
 */
class CsvFileConverter implements FileConverterInterface
{
    ...
    private function convert_csv_to_xml(FileObject $source_file, string $save_location): FileObject
    {
