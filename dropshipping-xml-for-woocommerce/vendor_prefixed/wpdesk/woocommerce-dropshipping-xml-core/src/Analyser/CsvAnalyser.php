...
class CsvAnalyser
{
    ...
    public function resolve_separator(FileObject $source_file): string
    {
    ...
    public function resolve_source_encoding(FileObject $source_file): string
    {
        $result = '';
    ...
    private function get_piece_of_content(FileObject $source_file): string
    {
