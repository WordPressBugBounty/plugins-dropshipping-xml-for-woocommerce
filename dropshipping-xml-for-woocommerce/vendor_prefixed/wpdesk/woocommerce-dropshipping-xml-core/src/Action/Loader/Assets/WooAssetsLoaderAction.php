 ...
 */
class WooAssetsLoaderAction implements Hookable, Conditional
{
    ...
    public function isActive(): bool
    {
        ...
        return $is_plugin_page && ($this->request->get_param('get.action')->getAsString() === MenuConfig::ACTION_MAPPER || $this->request->get_param('get.action')->getAsString() === MenuConfig::ACTION_OPTIONS);
    }
