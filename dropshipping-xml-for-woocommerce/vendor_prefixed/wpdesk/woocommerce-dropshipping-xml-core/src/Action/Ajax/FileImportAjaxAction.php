 ...
 */
class FileImportAjaxAction implements Conditional, Hookable
{
    ...
    public function __construct(Request $request, FileLocatorService $file_locator, FileConnectorService $file_connector, AjaxActionValidatorService $validator_service, FileFormatResolverService $file_format_resolver_service)
    {
    ...
    public function ajax_download_data()
    {
        try {
            ...
            $uid = $form_data[ImportFileFormFields::UID];
    ...
    private function validate_form_data()
    {
        ...
        if (!isset($form_data[ImportFileForm::ID][ImportFileFormFields::UID])) {
    ...
    private function prepare_form_data(): array
    {
        ...
        return $form_data[ImportFileForm::ID];
    }
}
