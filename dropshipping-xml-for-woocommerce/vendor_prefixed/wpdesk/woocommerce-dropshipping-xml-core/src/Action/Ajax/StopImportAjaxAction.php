 ...
 */
class StopImportAjaxAction implements Conditional, Hookable
{
     ...
     */
    private $import_dao;
    public function __construct(Request $request, AjaxActionValidatorService $validator_service, ImportDAO $import_dao)
    {
    ...
    public function ajax_process()
    {
        try {
            ...
            $import->set_status(Import::STATUS_STOPPED);
