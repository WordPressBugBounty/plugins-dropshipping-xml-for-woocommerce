...
class ConditionalLogicComponent extends \DropshippingXmlFreeVendor\WPDesk\Forms\Field\BasicField
{
    ...
    {
        if (!isset($this->items)) {
            $this->items = [(new SelectField())->set_name(self::FIELD_IMPORT)->add_class('select short width-100')->set_attribute('type', 'select')->set_options($this->get_import_options()), (new InputTextField())->add_class('width-100')->set_label(__('product if', 'dropshipping-xml-for-woocommerce'))->set_name(self::FIELD_XPATH)->set_placeholder(__('Xpath to field', 'dropshipping-xml-for-woocommerce')), (new SelectField())->set_label(__('field value is', 'dropshipping-xml-for-woocommerce'))->set_name(self::FIELD_VALUE_TYPE)->add_class('select short conditional-value-type width-100')->set_attribute('type', 'select')->set_options($this->get_value_types()), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_EQUAL_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_EQUAL)->set_placeholder(__('String, numeric value or xpath', 'dropshipping-xml-for-woocommerce')), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_NOT_EQUAL_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_NOT_EQUAL)->set_placeholder(__('String, numeric value or xpath', 'dropshipping-xml-for-woocommerce')), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_HIGHER_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_HIGHER)->set_placeholder(__('Numeric value or xpath', 'dropshipping-xml-for-woocommerce')), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_LOWER_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_LOWER)->set_placeholder(__('Numeric value or xpath', 'dropshipping-xml-for-woocommerce')), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_CONTAINS_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_CONTAINS)->set_placeholder(__('String, numeric value or xpath', 'dropshipping-xml-for-woocommerce')), (new InputTextField())->add_class('width-100')->set_name(self::FIELD_NOT_CONTAINS_VALUE)->set_attribute('data-value', self::FIELD_VALUE_TYPE_OPTION_NOT_CONTAINS)->set_placeholder(__('String, numeric value or xpath', 'dropshipping-xml-for-woocommerce'))];
        }
        return $this->items;
    }
