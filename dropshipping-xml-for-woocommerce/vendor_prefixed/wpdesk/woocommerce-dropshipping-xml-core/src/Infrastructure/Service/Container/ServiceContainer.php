...
class ServiceContainer implements ServiceContainerInterface
{
     ...
     */
    public function __construct(DependencyResolverInterface $resolver, ListenerCollectionInterface $listener)
    {
        $this->resolver = $resolver;
        $this->listener = $listener;
        $this->register_from_object($this, ServiceContainerInterface::class);
        $this->register_from_object($resolver, DependencyResolverInterface::class);
    }
    /**
