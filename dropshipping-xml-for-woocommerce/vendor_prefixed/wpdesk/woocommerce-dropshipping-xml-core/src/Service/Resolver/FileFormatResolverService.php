...
class FileFormatResolverService
{
     ...
     */
    private $data_format;
    public function __construct(DataFormatValidatorFactory $factory, DataFormat $data_format)
    {
        $this->validator_factory = $factory;
        $this->data_format = $data_format;
    }
    public function resolve_data_format(FileObject $file)
    {
        try {
            $mime_types = DataFormat::XML_MIME_TYPES;
    ...
    public function is_valid(FileObject $file, string $mime_type): bool
    {
