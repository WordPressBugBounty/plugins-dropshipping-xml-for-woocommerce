...
?>
									...
									<?php 
if ($form->has_field('ean')) {
    ?>
										<p class="form-field _ean_field ">
										<?php 
    $form->show_label('ean', ['template' => 'label']);
    ?>
										<?php 
    $form->show_field('ean');
    ?>
...
?>
										<?php 
$form->show_description('_manage_stock', ['template' => 'description']);
?>
									</p>
...
?>
										<?php 
$form->show_description('_sold_individually');
?>
									</p>
								</div>
